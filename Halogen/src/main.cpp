...
void TestSyzygy()
{
	...
	unsigned int result = tb_probe_wdl(testPosition.GetWhitePieces(), testPosition.GetBlackPieces(),
		...
		testPosition.GetCanCastleBlackKingside() * TB_CASTLING_k + testPosition.GetCanCastleBlackQueenside() * TB_CASTLING_q + testPosition.GetCanCastleWhiteKingside() * TB_CASTLING_K + testPosition.GetCanCastleWhiteQueenside() * TB_CASTLING_Q,
